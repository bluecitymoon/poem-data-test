...
/**
 * Created by jerryjiang on 28/4/2016.
 */
...
//        // 转换成拼音
//        System.out.println(PinyinTranslator.getFullSpell(str));
//        // 中文第一个字全拼,其余去首字母
//        System.out.println(PinyinTranslator.getFirstSpell(str));
//        // ascii 转 字母
//        System.out.println(PinyinTranslator.getSpellByAscii(65));
//        // 字母 转 ascii
...
//        }
        ...
        System.out.println(removeGuahaoThingsInString(test));
    }
    ...
    public static String removeGuahaoThingsInString(String input) {
        ...
        char[] destArray = new char[dest.size()];
