(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('poemdataApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-poemdataApp-error');
                var entityKey = httpResponse.headers('X-poemdataApp-params');
                if (errorHeader) {
