...
class PoemGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Poem entity")
        ...
        .repeat(2) {
            ...
            .post("/api/poems")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "anthorName":"SAMPLE_TEXT", "title":"SAMPLE_TEXT", "content":"SAMPLE_TEXT", "year":"SAMPLE_TEXT", "period":"SAMPLE_TEXT", "tag":"SAMPLE_TEXT", "resourceId":"SAMPLE_TEXT", "titlePinyin":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
